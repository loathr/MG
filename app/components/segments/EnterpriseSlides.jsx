...
export function styledHighlight(t, slide, opts) {
  ...
  if (style === "underline") return <div style={Object.assign({}, { marginTop: 6 }, ht)}><div style={Object.assign({}, textStyle, { borderBottom: "2px solid " + accent, paddingBottom: 2, fontStyle: "italic", display: "inline", background: "rgba(0,0,0,0.6)", padding: "2px 6px", color: "#ffffff" })}>{t}</div></div>;
