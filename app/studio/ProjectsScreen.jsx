...
import { relativeTime, groupDecks, groupCollapsedByDefault } from "./cloud";
import { Settings, LogOut, Plus, Search, Trash2, MoreHorizontal, FolderOpen, ChevronDown, ChevronRight } from "lucide-react";
...
export default function ProjectsScreen({ projects, onOpen, onNew, onDelete, email, onSignOut, isAdmin, onAdmin, nowMs }) {
  ...
  const totalSlides = (projects || []).reduce((n, p) => n + (p.slideCount || 0), 0);
