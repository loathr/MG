...
const HOME_FALLBACK = {
  ...
  heroLead:
    "Loathr is a strategy-led creative consultancy. We build your company a stronger brand, execute meaningful projects, and create lasting impact. Strategy first, creative throughout.",
  marquee: MARQUEE,
  ...
  homePillars: [
    { n: "01", title: "Strategy", desc: "Clarity, direction, and priorities that become your company’s competitive advantage.", items: ["Brand Strategy", "Business Consultancy", "Project Management"] },
    ...
    { n: "03", title: "Growth", desc: "Turning presence into demand, and perception into your company’s most valuable asset.", items: ["Marketing", "Social Media", "Web Design", "Digital Support"] },
  ],
